...
[Rendering Rule]
전달받은 6개 비트의 순서와 핵심을 정확히 유지한다. 각 비트의 사주 근거·현실 장면·감정 방향을 반드시 모두 살려 220~320자의 풍성한 문단 하나로 쓴다. 비트 밖의 사실, 직업, 건강 상태, 금전 수익을 지어내지 않는다. ‘대본의 사실’은 바꾸지 말고, 표현과 연결만 다봄의 말투로 바꾼다.
