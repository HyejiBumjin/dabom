...
[Output]
JSON의 sections 배열에 outline과 같은 순서로 6개를 넣는다. 각 section에는 section_id, paragraph, fragment_ids를 넣는다. fragment_ids에는 실제 사용한 이 section의 fragment ID만 한 개 이상 넣는다. 제목·번호·마크다운은 paragraph에 쓰지 않는다.`;
